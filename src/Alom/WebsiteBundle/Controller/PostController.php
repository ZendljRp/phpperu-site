...
class PostController extends Controller
{
    ...
    public function viewAction($slug)
    {
        ...
        if ($request->getMethod() === 'POST') {
            ...
            if ($form->isValid()) {
                ...
                $this->get('session')->getFlashBag()->set('post_comment_confirmation', 'Your comment was successfully posted');
    ...
    public function listAction($year = null)
    {
        ...
        if (count($posts) == 0) {
            ...
            return $this->redirect($this->generateUrl('blog_post_create'));
        }
    ...
    public function editAction($id = null)
    {
        ...
        if ($this->get('request')->getMethod() === 'POST') {
            ...
            if ($form->isValid()) {
                ...
                $post->setBodyHtml($this->get('cordoval.blog.rst2html')->convert($post->getBody()));
                $em->persist($post);
                $em->flush();
    ...
    public function markdownPreviewAction()
    {
        ...
        $content = $this->get('cordoval.blog.rst2html')->convert($markdown);
